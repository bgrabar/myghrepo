...
# NOTE:
# Version 1 (makeBuckets1.sh) was based on an all.files.<lib>.txt file that contained
...
while read line; do
    ...
    mkdir -p /gds_02/data/buckets-uc1/bucket$x/${line}/

    mv $line /gds_02/data/buckets-uc1/bucket$x/${line}/
